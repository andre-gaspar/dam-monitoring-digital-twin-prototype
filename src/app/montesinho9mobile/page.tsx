...
import { initialSensors } from "@/components/montesinho9mobile/initialSensors";
import { MontesinhoScene } from "@/components/montesinho9mobile/Scene";
import { OverlayModal } from "@/components/montesinho9mobile/OverlayModal";
import { RainControlPanel } from "@/components/montesinho9mobile/RainControlPanel";
import { SensorSidebar } from "@/components/montesinho9mobile/SensorSidebar";
import { TimelineDock } from "@/components/montesinho9mobile/TimelineDock";
import { WaterPlaybackPanel } from "@/components/montesinho9mobile/WaterPlaybackPanel";
import {
  PLAYBACK_INTERVAL_MS,
} from "@/components/montesinho9mobile/constants";
import type {
  ApiResponse,
  MonitoringSensorItem,
  WaterLevelRow,
  WaterStats,
} from "@/components/montesinho9mobile/types";
import {
  addOneDay,
  mapWaterLevelToSceneY,
} from "@/components/montesinho9mobile/utils";
...
export default function Page() {
  ...
  const [isSensorSidebarOpen, setIsSensorSidebarOpen] = useState(false);
