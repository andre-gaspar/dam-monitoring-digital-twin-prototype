...
import { VRMontesinhoWorld } from "@/components/vrtest8/VRMontesinhoWorld";
import { CameraSetup, WebXRSetup } from "@/components/vrtest8/VRBasics";
import {
  DraggableMeteorologiaChart,
  ModePanel,
  VRDashboardPanel,
  type DashboardButtonRefs,
} from "@/components/vrtest8/VRPanels";
import {
  HandInputSystem,
  type DraggableTarget,
  type InteractionMode,
  type VRButtonTarget,
} from "@/components/vrtest8/VRInteractionSystem";
import {
  ...
  TIMELINE_START_DATE,
  USER_EYE_HEIGHT,
} from "@/components/vrtest8/constants";
    ...
    >
      ...
      >
        <div style={{ fontWeight: 800, marginBottom: 8 }}>
          Quest 3 VR — Montesinho8
        </div>
        <div style={{ fontSize: 13 }}>
          Use hand tracking. Ray mode: point + pinch to drag panels. Grab mode:
          pinch a panel directly; pinch with the other hand to scale.
        </div>
      </div>
    </main>
  );
