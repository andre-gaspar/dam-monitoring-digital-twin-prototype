...
export function TimelineDock({
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-0 z-50 px-3 pb-[calc(env(safe-area-inset-bottom,0px)+12px)]">
      <div className="mx-auto flex w-full max-w-md flex-col items-center">
        <Button
          ...
          className={cn(
            "pointer-events-auto mb-2 h-11 w-11 rounded-full shadow-2xl transition-all duration-300",
            isOpen
        ...
        <div
          className={cn(
            ...
            isOpen
              ? "max-h-[52dvh] translate-y-0 opacity-100"
              : "pointer-events-none max-h-0 translate-y-4 overflow-hidden opacity-0"
          )}
          aria-hidden={!isOpen}
        >
          <Card className="gap-0 overflow-visible rounded-xl border-white/20 bg-white/95 px-3 py-3 text-black shadow-2xl backdrop-blur-md">
            <div className="mb-3 flex flex-col gap-2">
              <div className="text-sm font-semibold">Monitoring timeline</div>

              <div className="rounded-full bg-black px-3 py-1 text-center text-[11px] font-medium text-white">
            ...
            <div className="flex flex-col gap-3">
              <div className="relative flex items-center gap-2">
                <Button
                  ...
                  className="h-10 w-10 rounded-full border-black/10 bg-white text-black shadow-sm hover:bg-neutral-100"
