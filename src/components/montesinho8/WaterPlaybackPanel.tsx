...
export function WaterPlaybackPanel({
  ...
  return (
    <Card
      className={cn(
        "absolute right-5 top-1/2 z-10 w-80 gap-0 rounded-xl border-black/10 bg-white/95 p-3.5 py-3.5 text-black shadow-2xl backdrop-blur-md transition-all duration-300 ease-out",
        isVisible
